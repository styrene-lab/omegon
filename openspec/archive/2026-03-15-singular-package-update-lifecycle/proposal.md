+++
id = "3be4797a-c760-4bd6-a8e7-ebc470ff081a"
tags = []
aliases = []
...
- pi-mono local fork worktree reconciliation (resolved)
- Singular package runtime boundary and ownership (resolved)
- Update lifecycle parity and restart boundary (resolved)
