...
aliases = ["local-inference-onboarding"]
...
open_questions = ["What is the minimum model that can meaningfully drive a tutorial — can a 4B model do single-tool-call steps, or do we need 14B+ for reliable tool use?"]
