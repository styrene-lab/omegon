            ...
            groups: vec![MenuGroupProjection {
                ...
                rows: vec![
                    MenuRowProjection {
                        ...
                        metadata: vec!["/memory_recall <query>".into()],
                        primary_action: Some(MenuActionProjection::prime_editor("memory.recall.primary", "Recall", "/memory_recall ", "Type a memory recall query, then press Enter")),
                        actions: vec![],
                        safety: None,
                        availability: None,
                    },
                    MenuRowProjection {
                        ...
                        kind: MenuRowKind::Action,
                        badges: vec![MenuBadgeProjection { label: "read".into(), tone: MenuBadgeTone::Neutral }],
                        metadata: vec!["/memory_list".into()],
                        primary_action: Some(MenuActionProjection::command("memory.list.primary", "List", "/memory_list")),
                        actions: vec![],
                        safety: None,
                        availability: None,
                    },
                    MenuRowProjection {
                        ...
                        metadata: vec!["/memory_focus <topic>".into()],
                        primary_action: Some(MenuActionProjection::prime_editor("memory.focus.primary", "Focus", "/memory_focus ", "Type a memory topic to focus, then press Enter")),
                        actions: vec![],
                        safety: None,
                        availability: None,
                    },
                    MenuRowProjection {
                        ...
                        metadata: vec!["/memory_release <topic>".into()],
                        primary_action: Some(MenuActionProjection::prime_editor("memory.release.primary", "Release", "/memory_release ", "Type a memory topic to release, then press Enter")),
                        actions: vec![],
                        safety: None,
                        availability: None,
                    },
                    MenuRowProjection {
                        ...
                        kind: MenuRowKind::Action,
                        badges: vec![MenuBadgeProjection { label: "mutates".into(), tone: MenuBadgeTone::Warning }],
                        metadata: vec!["/memory_compact".into()],
                        primary_action: Some({ let mut action = MenuActionProjection::command("memory.compact.primary", "Compact", "/memory_compact"); action.requires_confirmation = true; action }),
                        actions: vec![],
                        safety: None,
                        availability: None,
                    },
