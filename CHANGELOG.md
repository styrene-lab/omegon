...
- Add and harden a dogfood Rust surface evidence generator that uses nightly rustdoc JSON to populate `.omegon/evidence/surfaces.jsonl`, resolve source paths/hashes, filter derive noise, render basic signatures, and append `surface-map` evidence records.
