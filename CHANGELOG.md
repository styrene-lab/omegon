...
- Restored the persistent web-search readiness status in the default Om footer; presentation compression no longer removes `WEB` / degraded `WEB! ddg-only` visibility.
