...
### Added
- Added a guarded `/runtime restart` hot-restart preview surface with runtime generation status so the extension/runtime reload design has an operator-visible command seam before substrate swapping lands.
