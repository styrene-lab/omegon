...
- Added `/skill` as a visible command-menu alias for `/skills`, and advertised `/skills reload` plus `/skills refresh` in the shared command registry and ACP help so reload affordances appear in command discovery surfaces.
