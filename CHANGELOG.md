...
- The session footer now omits duplicated plan/workbench labels, model route, and context percentage; those states remain available in their authoritative Workbench, engine, and context surfaces while the footer keeps only immediate turn state and session/workspace telemetry.
