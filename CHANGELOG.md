...
- Added the first unified semantic color-language hardening target for Om: signal colors are reserved for lifecycle and attention rather than allowing tool-category accents to make routine success look like warnings.
