...
- Add a dogfood Rust surface evidence generator that uses nightly rustdoc JSON to populate `.omegon/evidence/surfaces.jsonl` and append `surface-map` evidence records.
