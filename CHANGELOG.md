...
- Improved slim TUI tool-row summaries so skipped validation, shell errors, edit/commit outcomes, and search result counts surface as concise row outcomes instead of generic first-line result text.
