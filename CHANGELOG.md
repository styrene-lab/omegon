...
- Add a native `omegon-tdd-savepoint` extension scaffold exposing TDD savepoint diff hashing and evidence classification tools while preserving the existing core CLI kernel during extraction.
