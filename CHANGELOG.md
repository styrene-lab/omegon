...
- Added GPT-5.6 to the OpenAI and OpenAI Codex model registry defaults, S-grade routes, and model selector entries; Codex GPT-5.6 now records upstream minimum client versions and blocks stale Codex CLI versions before dispatching.
