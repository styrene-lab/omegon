...
- Define the Project Rules policy boundary so OpenSpec remains descriptive, evidence findings stay advisory by default, and per-project/CI contexts own hard-deny behavior.
